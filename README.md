...
<br />
## Performance:
The input lag for an arcade controller built around this project is minimal. Here is the result from a [test with a 1ms polling rate]([url](https://inputlag.science/controller/methodology)):  
